          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              <div className="flex items-center mb-4">
                ...
                <span className="text-xl font-bold">INXCODE</span>
              </div>
            ...
            <div>
              ...
              {isSubscribed ? (
                <div className="bg-green-600 text-white px-4 py-3 rounded-lg flex items-center">
                ...
                <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
                  >
                    Subscribe
                  </button>
                </form>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-gray-400 text-sm">
              <p>
                © {currentYear} INXCODE Pvt Ltd. All rights reserved.
              </p>
              <p className="mt-1">
                Made with ❤️ by INXCODE
              </p>
            </div>
